...
const Footer = () => {
  return (
    <Box
      sx={{
        minHeight: { xs: "auto", md: "300px", backgroundColor: "#16111D" },
    ...
    >
      ...
      >
        ...
        <Stack gap={2} sx={{ marginTop: { xs: "1rem", md: 0 } }}>
          ...
          <Image
            ...
            style={{ cursor: "pointer" }}
          />
          <Typography variant="h5" sx={{ color: "#fff", marginTop: "1rem" }}>
            Stay Tuned
          </Typography>
      ...
      >
        <Image src="/affworld.ico" width={80} height={80} alt="company_logo" />
